...
def main(argv):
  ...
  try:
    ...
    '''event = {
      ...
      'location': 'Somewhere',
      'start': {
        'dateTime': '2013-05-03T10:00:00.000-07:00'
      },
      'end': {
        'dateTime': '2013-05-03T10:25:00.000-07:00'
      },
      
    }

    created_event = service.events().insert(calendarId='csce670information@gmail.com', body=event).execute()
